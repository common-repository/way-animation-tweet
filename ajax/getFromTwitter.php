<? session_start();
    ...
    //$consumerKey        = 'Z00I3Cp4XQfzQ9VsuChZzEfJE';
    //$consumerSecret     = 'RA5zYSWXKrd7J82Ywi7sY7eilxLQa9esxGWvSWYoOJAqkWb45V';
    //$accessToken        = '2549249701-1Nuart0RHEEOtFdNMlYbA0qQQWMGPNb7j0aCFV5';
    //$accessTokenSecret  = 'ULMA1l29A8lcNn5NOdGzatJb16LnVErEhr1rKfivyyBcM';
    
    $consumerKey        = $_SESSION["apikey"];
    $consumerSecret     = $_SESSION["apisecret"];
    $accessToken        = $_SESSION["accesstoken"];
    $accessTokenSecret  = $_SESSION["accesssecret"];
